...
async def test_delete_user():
        ...
        res = requests.delete('http://localhost:8000/users/9')
        assert res.status_code == 200
    ...
    #b'[{"id":1,"name":"sha","email":"petuk@example.com","created_at":"2024-02-11T18:04:17.732550+00:00","address":"berlin","phone_numbers":[{"id":1,"phone_number":"12345"},{"id":2,"phone_number":"34567"}]}]'
